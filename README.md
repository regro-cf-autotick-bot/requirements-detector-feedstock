...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/requirements-detector-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/requirements-detector-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add requirements-detector
# for installing globally
pixi global install requirements-detector
```
...
It is possible to list all of the versions of `requirements-detector` available on your platform:
...
```
pixi search requirements-detector --channel conda-forge
```
